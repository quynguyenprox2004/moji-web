...
function BoardContent({
  ...
  // Điểm va chạm cuối cùng trước đó (xử lý thuật toán phát hiện va chạm, v37)
  const lastOverId = useRef(null)

  useEffect(() => {
    // Columns đã được sắp xếp ở component cha cao nhất (boards/_id.jsx) (V71 Fix bug quan trọng)
  ...
  const moveCardBetweenDifferentColumns = (
    ...
    setOrderedColumns(prevColumns => {
      ...
      if (nextActiveColumn) {
        ...
        // Thêm Placeholder Card nếu Columns rỗng: Bị kéo hết Card đi, không còn cái nào nữa. (V37.2)
      ...
      if (nextOverColumn) {
        ...
        // Xóa cái Placeholder Card đi nếu nó đang tồn tại (V37.2)
      ...
      if (triggerFrom === 'handleDragEnd') {
        /**
         * Gọi lên props func moveCardToDifferentColumn nằm ở component cha cao nhất (boards/_id.jsx)
    ...
    if (activeDragItemType === ACTIVE_DRAG_ITEM_TYPE.CARD) {
      ...
      if (oldColumnWhenDraggingCard._id !== overColumn._id) {
        ...
        setOrderedColumns(prevColumns => {
          ...
          // Cập nhât lại 2 giá trị mới là card và cardOrderIds trong cái targetColumn
  ...
  const collisionDetectionStrategy = useCallback((args) => {
    ...
    // V37.1: Nếu pointerIntersections là mảng rỗng, return luôn không làm gì hết.
    ...
    // // Thuật toán phát hiện va chạm sẽ trả về một mảng các va chạm ở đây (không cần bước này nữa -v37.1)
    ...
    if (overId) {
      // V37: Đoạn này để fix cái vụ flickering.
      ...
      // Nếu không có đoạn checkColumn này thì bug flickering vẫn fix được rồi nhưng mà kéo thả sẽ rất giật giật lag lag.
